...
class HomeScreenFine extends StatefulWidget {
  @override
  _HomeScreenFineState createState() => _HomeScreenFineState();
}

class _HomeScreenFineState extends State<HomeScreenFine> {
